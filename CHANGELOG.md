...
3. Added `scale_air_temperature_to_height` to output a temperature value for any height by applying a constant lapse rate to a known reference temperature value at a reference measurement height ([[#530](https://github.com/brightwind-dev/brightwind/issues/530)])
4. Updated `calc_air_density` to include relative humidity as suggested in IEC Standards (61400-12-1) ([[#535](https://github.com/brightwind-dev/brightwind/issues/535)])
