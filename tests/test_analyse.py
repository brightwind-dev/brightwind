...
def test_lapse_temperature():
    assert bw.lapse_temperature(10.0065, 10, 11, print_details=True) == 10.0
    assert bw.lapse_temperature(DATA.T2m.loc['2016-01-09 17:10'], 4, 2, lapse_rate= -0.005)
    pd.testing.assert_series_equal(bw.lapse_temperature(DATA.T2m.loc['2016-01-09 17:10':'2016-01-09 18:00'], 2, 20, print_details=True),
