...
12. Updated `_MeasurementStation__load_wra_data_model` function to validate data model against task 43 schema for the relevant version (Issue [#489](https://github.com/brightwind-dev/brightwind/issues/489)).
