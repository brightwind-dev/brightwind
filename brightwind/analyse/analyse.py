...
from brightwind.transform.transform import apply_scale_factor
...
def freq_table(var_series, direction_series, var_bin_array=np.arange(-0.5, 41, 1), var_bin_labels=None, sectors=12,
    ...
    **Example usage**
    ...
    if target_freq_table_mean is not None:
        ...
        var_series_scaled = apply_scale_factor(data_concurrent[var_series.name], scale_factor)
    else:
    ...
    while k > 0:
        ...
        if target_freq_table_mean is None:
            ...
            var_series_scaled = apply_scale_factor(var_series_scaled, scale_factor)
