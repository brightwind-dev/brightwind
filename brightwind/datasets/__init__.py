...
__all__ = ['demo_data', 'demo_campbell_scientific_data', 'demo_merra2_NW',
           ...
           'demo_windographer_flagging_log', 'demo_windographer_flagging_log2', 'demo_cleaning_file']
...
demo_windographer_flagging_log = os.path.join(os.path.dirname(__file__), 'demo', 'windographer_flagging_log.txt')
demo_windographer_flagging_log2 = os.path.join(os.path.dirname(__file__), 'demo', 'windographer_flagging_log2.txt')
demo_cleaning_file = os.path.join(os.path.dirname(__file__), 'demo', 'demo_cleaning_file.csv')
