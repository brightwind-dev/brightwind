...
def time_continuity_gaps(data):
    ...
    A missing data period is one where data is not available for some consecutive timestamps. Also, where a 
    timestamp exists for a row of data, but where all values in that row are NaN's, this row will also be considered
    a time continuity gap as it represents a break in the ordinary functioning of the logging unit.
    
    The function derives the temporal resolution of the data by
