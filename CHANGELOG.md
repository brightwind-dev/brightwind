...
2. Bug fix for `get_table` function (Issue [#421](https://github.com/brightwind-dev/brightwind/issues/421)).
3. Write new note here (Issue [#4xx](https://github.com/brightwind-dev/brightwind/issues/4xx)).
