...
4. Bug fix in `_Measurements_get_table` function (Issue [#421](https://github.com/brightwind-dev/brightwind/issues/421)).
...
6. Bug fix in `_Measurements__get_properties` function when sensor can measure multiple measurement types. If there are multiple calibrations present, the correct one is now chosen (Issue [#449](https://github.com/brightwind-dev/brightwind/issues/449)).
7. Bug fix in `_Measurements__get_properties` function to handle solar sites (Issue [#453](https://github.com/brightwind-dev/brightwind/issues/453)).
...
9. Added options for display of legend and grid for `plot_timeseries` function (Issue [#457](https://github.com/brightwind-dev/brightwind/issues/457)).
10. Write new note here (Issue [#4xx](https://github.com/brightwind-dev/brightwind/issues/4xx)).
