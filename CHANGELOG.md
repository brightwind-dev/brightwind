...
4. Updated `plot_scatter`, `plot_scatter_wdir`, `plot_scatter_wspd`, `CorrelBase.plot()` and `SpeedSort.plot_wind_directions()`, to accept an `ax` parameter to support use in subplots ([#596](https://github.com/brightwind-dev/brightwind/issues/596)).
