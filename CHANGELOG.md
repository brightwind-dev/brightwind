...
## [2.4.0-dev]
1. Edited `offset_timestamps()` to include last timestamp when date_from is unspecified, so that offset is applied to the entire record. ([#504](https://github.com/brightwind-dev/brightwind/issues/504))
