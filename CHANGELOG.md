...
2. Added `extrapolate_density` to output an air density value for any height by applying a constant lapse rate to a known reference air density value at a reference measurement height ([[#534](https://github.com/brightwind-dev/brightwind/issues/534)]) 
2. Added `extrapolate_temperature` to output a temperature value for any height by lapsing a known reference temperature value at a reference measurement height ([[#530](https://github.com/brightwind-dev/brightwind/issues/530)]) 
