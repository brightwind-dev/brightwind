...
1. Updated `apply_wspd_slope_offset_adj` in order to also apply slope offset adjustment to related columns (for 'avg', 'min', 'max' and 'sd' statistic types) in addition to the main variable itself ([#575](https://github.com/brightwind-dev/brightwind/issues/575)).
