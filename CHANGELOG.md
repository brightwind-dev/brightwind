...
2. Added `lapse_density` to output an air density value for any height by lapsing a known reference air density value at a different measurement height ([[#534](https://github.com/brightwind-dev/brightwind/issues/534)]) 
