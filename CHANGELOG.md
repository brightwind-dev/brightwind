...
2. Added `scale_pressure_to_height` to output a pressure value for any height based on reference temperature and pressure values at a different measurement height ([[#531](https://github.com/brightwind-dev/brightwind/issues/531)]) 
