...
2. Added `scale_air_pressure_to_height` to output a air pressure value for any height based on reference air temperature and air pressure values at a different measurement height ([[#531](https://github.com/brightwind-dev/brightwind/issues/531)]) 
